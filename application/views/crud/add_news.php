...
<div class="container">
	 <form id="form_Add" action="<?php echo site_url('Crud/proses_add_news')?>" role="form" method="POST" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-md-12 col-lg-12">
				<div class="form-grub">
					...
					<textarea name="berita" class="form-control" rows="17"><?php echo"<p class='lead'></p><p></p>"; ?></textarea>
				</div>
			</div>
			<div class="col-md-12 col-lg-12">
				<div class="form-grub">	
